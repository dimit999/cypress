...
export class ShippingAddressPage extends BasePage {
  ...
  private uniquePageSelector = "//div[contains(text(), 'Shipping')]";
  private streetAddressInput = new Input(
    "(//input[contains(@class, 'input')])[6]",
    true,
  );
  private cityInput = new Input(
    "(//input[contains(@class, 'input')])[9]",
    true,
  );
  private stateDropDown = new DropDown(
    "(//select[contains(@class, 'select')])[1]",
    true,
  );
  private zipCodeInput = new Input(
    "(//input[contains(@class, 'input')])[11]",
    true,
  );
  private phoneNumberInput = new Input(
    "(//input[contains(@class, 'input')])[12]",
    true,
  );
  private nextButton = new Button("//span[contains(text(), 'Next')]", true);

  private fixedRateButton = new Button(
    "(//td[contains(@class, 'col')]//input[contains(@class, 'radio')])[1]",
    true,
  );
  private fixedRatePrice = new Label(
    "(//span[contains(@class, 'price')]//span[contains(@class, 'price')])[1]",
    true,
  );
